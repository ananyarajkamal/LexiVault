...
from llm.prompts import DECISION_BRIEF_PROMPT

def generate_brief(chunks: list, language: str) -> str:
    ...
    try:
        ...
        prompt = DECISION_BRIEF_PROMPT.format(context=context, language=language)
