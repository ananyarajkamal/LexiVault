...
CLAUSE_EXTRACTION_PROMPT = (
    ...
    "Mark any clause as NOT FOUND if absent. Flag unusual or one-sided terms by appending the word RISK to the value string. "
...
SHADOW_BATTLE_PROMPT = (
    ...
    "CRITICAL: You must generate the ENTIRE response (including all section titles, headers, and body text) in the requested language: {language}.\n"
    "If the language is 'Hindi', write everything in Devanagari script.\n"
    "If the language is 'Hinglish', write everything in conversational Hinglish (Hindi words written in the Latin/English alphabet).\n"
    "Do not use English for headers or debate if Hindi or Hinglish is selected.\n"
