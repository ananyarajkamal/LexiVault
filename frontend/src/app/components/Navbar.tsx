        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#092E26] to-[#0A3D32] text-white flex items-center justify-center shrink-0 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-300">
              ...
              >
                {/* Shield Outline */}
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" className="group-hover:stroke-[#E6F0ED] transition-colors duration-300" />
                {/* Book Pages Outline */}
            ...
            <span className="font-bold text-[20px] text-[#092E26] tracking-tight font-sans group-hover:text-[#0B7A63] transition-colors duration-300">LexiVault</span>
          </div>
